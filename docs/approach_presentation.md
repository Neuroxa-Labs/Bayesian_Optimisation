...
Week 13 / final round is complete (**4/8 improved**: F4, F5, F7, F8). Near-pure exploitation worked where basins were proven: F5 climbed to **≈3813** at x₁=`0.45`; F4/F7/F8 took micro-steps to new bests; F3 held −0.011; F1’s signal lobe improved to −0.00457 (still below seed max). F2 and F6 missed their sharp historical peaks. Full notes: `weeks/WEEK13_REFLECTION.md`.
