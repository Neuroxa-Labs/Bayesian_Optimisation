...
**Size (after Week 13 / final-round results).** Approximately:
...
**Time frame.** Stage 2 weekly cycles across the module calendar (initial seed data from the course plus thirteen completed query rounds through Week 13 (final), documented in `weeks/WEEK13_STRATEGY.md` and `weeks/WEEK13_REFLECTION.md`).
