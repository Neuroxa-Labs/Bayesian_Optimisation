...
- `x1`: length-scale = 0.1287 -> **very sensitive** - small changes move y a lot (take small steps)
- `x2`: length-scale = 0.0137 -> **very sensitive** - small changes move y a lot (take small steps)
...
- **GP had expected:** mu = -8.151e-16, sigma = 1.939e-09
- **Outcome:** did **not** improve over the previous best (7.711e-16).
