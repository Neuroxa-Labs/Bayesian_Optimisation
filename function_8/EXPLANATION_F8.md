...
## 2. What we were given (40 initial points + 3 weekly queries = 43 observations)
...
| 43 | 0.0700 | 0.0700 | 0.0200 | 0.0388 | 0.4039 | 0.9300 | 0.0200 | 0.8931 | 9.6064 |  |
...
- `x1`: length-scale = 3.7039 -> moderate influence
- `x2`: length-scale = 5.7433 -> **degenerate** - GP sees little effect from this dimension (it locks it)
- `x3`: length-scale = 2.6921 -> moderate influence
- `x4`: length-scale = 9.7449 -> **degenerate** - GP sees little effect from this dimension (it locks it)
- `x5`: length-scale = 10.0000 -> **degenerate** - GP sees little effect from this dimension (it locks it)
- `x6`: length-scale = 7.0687 -> **degenerate** - GP sees little effect from this dimension (it locks it)
- `x7`: length-scale = 3.8371 -> moderate influence
...
- **Received:** y = 9.6064
- **GP had expected:** mu = 9.6064, sigma = 0.0033
- **Outcome:** did **not** improve over the previous best (9.7956).
