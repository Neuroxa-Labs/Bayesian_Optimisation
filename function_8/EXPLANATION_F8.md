...
## 2. What we were given (40 initial points + the Week 1 point = 41 observations)
...
| 27 | 0.1926 | 0.6307 | 0.4168 | 0.4905 | 0.7961 | 0.6546 | 0.2762 | 0.2955 | 9.3443 |  |
...
- `x1`: length-scale = 3.5998 -> moderate influence
- `x2`: length-scale = 5.7034 -> **degenerate** - GP sees little effect from this dimension (it locks it)
- `x3`: length-scale = 2.6628 -> moderate influence
- `x4`: length-scale = 9.3005 -> **degenerate** - GP sees little effect from this dimension (it locks it)
- `x5`: length-scale = 10.0000 -> **degenerate** - GP sees little effect from this dimension (it locks it)
- `x6`: length-scale = 7.3456 -> **degenerate** - GP sees little effect from this dimension (it locks it)
- `x7`: length-scale = 3.7496 -> moderate influence
