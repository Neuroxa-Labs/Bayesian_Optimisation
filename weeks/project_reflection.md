...
**Weeks 11–13.** Clustering / PCA discussion lenses matched what the code already did — stay inside proven basins; move only sensitive axes. Week 11 improved F4/F5/F7/F8 again but **collapsed F6** (−0.136 → −0.372) after a small step off the Week 10 centroid; the code/policy response was a hard-return rule. Week 12 continued the F5 ridge (x₁=0.44 → ≈3801), micro-gains on F4/F7/F8, and a partial F6 recovery (−0.205), while F2 again missed the 0.777 needle. **Week 13 (final)** again improved **4/8** (F4 0.679, F5 ≈3813 at x₁=0.45, F7 1.878, F8 9.874); F3 held −0.011; F1’s lobe reached −0.00457; F2/F6 missed. Repository work matured in parallel: datasheet and model card, HTML dashboard, strategy hub, and an ARD-axis cluster gallery.
...
Score evolution in the last stretch was clear if uneven. **Week 10:** 5/8 new bests (including F6 −0.136 and F1 signal). **Week 11:** 4/8 (F4 0.675, F5 ≈3790, F7 1.866, F8 9.872) but F6 and F2 failed. **Week 12:** again 4/8 (F4 0.679, F5 ≈3801, F7 1.872, F8 9.873), F6 partial return, F2 still off the 0.777 peak. **Week 13:** again 4/8 (F4 0.679, F5 ≈3813, F7 1.878, F8 9.874); F3 held; F2/F6 missed. Some landscapes rewarded the local policy strongly (F4/F5/F7/F8); others stayed fragile (F2’s razor ridge; F1’s sparse detection problem; F6’s sharp cake basin).
