...
| # | x1 | x2 | x3 | x4 | y | note |
|---|---|---|---|---|---|---|
| 23 | 0.1500 | 0.9265 | 0.9800 | 0.9800 | 3108.4879 | BEST |
...
- **Best so far:** y = 3108.4879 at x = [0.1500, 0.9265, 0.9800, 0.9800]
...
- `x1`: length-scale = 2.0255 -> moderate influence
- `x2`: length-scale = 0.7443 -> moderate influence
- `x3`: length-scale = 0.3194 -> **very sensitive** - small changes move y a lot (take small steps)
...
- **GP had expected:** mu = 3108.4758, sigma = 0.8367
